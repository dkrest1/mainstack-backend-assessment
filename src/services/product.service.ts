...
class ProductService {
    ...
    async addProduct (createProductRequest: CreateProductRequest): Promise<PRODUCTS>  {
        ...
        if(createProductRequest.file) {
            const productImage = 
                await this.uploadService.upload( null, createProductRequest.file.data!, createProductRequest.file.title!)
    ...
    async updateProduct (productId: string, updateProductRequest: UpdateProductRequest): Promise<PRODUCTS | null> {
        ...
        if(updateProductRequest.file) {
            ...
            const updateImage = 
                await this.uploadService.upload( prodcutImageId, updateProductRequest.file.data!, updateProductRequest.file.title!)
